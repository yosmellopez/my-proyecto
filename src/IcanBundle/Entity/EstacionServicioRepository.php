...
class EstacionServicioRepository extends EntityRepository
{
    ...
    /**
     * ListarEstacionServicio: Lista los marca
    ...
    /**
     * TotalEstacionServicio: Total de marca de la BD
     * @param string $sSearch Para buscar
     *
     * @author Marcel
     */
    public function TotalEstacionServicios($sSearch)
    {
        ...
        $consulta = 'SELECT COUNT(m.estacionId) FROM IcanBundle\Entity\EstacionServicio m ';
        $where = '';
