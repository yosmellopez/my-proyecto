...
class ServicioController extends BaseController
{
    ...
    public function indexAction() {
        ...
        $servicio = $this->getDoctrine()->getRepository('IcanBundle:Servicio')->DevolverServicio();

        return $this->render('IcanBundle:Servicio:index.html.twig', array('servicio' => $servicio,));
    }
    ...
    public function CargarDatosServicio($servicio_id) {
        ...
        if ($entity != null) {
            ...
            $servicio_imagenes = $this->getDoctrine()->getRepository('IcanBundle:ServicioImagen')->ListarImagenes($servicio_id);
            $imagenes = array();
            $cont = 0;
    ...
    public function EliminarImagen($imagen) {
        ...
        $entity = $this->getDoctrine()->getRepository('IcanBundle:ServicioImagen')->findOneBy(array('imagen' => $imagen));
        if ($entity != null) {
        ...
        if ($imagenes != "") {
            ...
            foreach ($imagenes as $value) {
                if ($value != "") {
                    ...
                    $servicio_imagen = $this->getDoctrine()->getRepository('IcanBundle:ServicioImagen')->findOneBy(array('imagen' => $value));
