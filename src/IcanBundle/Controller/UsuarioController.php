...
class UsuarioController extends BaseController
{
    ...
    public function perfilAction() {
        ...
        return $this->render('IcanBundle:Usuario:perfil.html.twig', array('usuario' => $usuario));
    }
    ...
    public function indexAction() {
        ...
        $perfiles = $this->getDoctrine()->getRepository('IcanBundle:Rol')->ListarOrdenados();


        return $this->render('IcanBundle:Usuario:index.html.twig', array('perfiles' => $perfiles));
    }
    ...
    public function salvarAction(Request $request) {
        ...
        if ($usuario_id == "") {
            $resultado = $this->SalvarUsuario($rol_id, $habilitado, $contrasenna, $nombre, $apellidos, $email);
        } else {
            $resultado = $this->ActualizarUsuario($usuario_id, $rol_id, $habilitado, $contrasenna, $nombre, $apellidos, $email);
        }
    ...
    public function AutenticarLogin($email, $pass) {
        ...
        $usuario = $this->getDoctrine()->getRepository('IcanBundle:Usuario')->AutenticarLogin($email, $pass);
        if ($usuario != null) {
    ...
    public function ActualizarMisDatos($usuario_id, $contrasenna, $nombre, $apellidos, $email) {
        ...
        if ($entity != null) {
            //Verificar email
            $usuario = $this->getDoctrine()->getRepository('IcanBundle:Usuario')->BuscarUsuarioPorEmail($email);
            if ($usuario != null) {
    ...
    public function CargarDatosUsuario($usuario_id) {
        ...
        $usuario = $this->getDoctrine()->getRepository('IcanBundle:Usuario')->find($usuario_id);
        if ($usuario != null) {
    ...
    public function RecuperarContrasenna($email) {
        ...
        if (!is_null($usuario)) {
            ...
            $mensaje->setSubject($asunto)->setFrom($direccion_from)->setTo($email)->setBody($this->renderView('IcanBundle:Mailing:mail.html.twig', array('direccion_url' => $direccion_url, 'asunto' => $asunto, 'receptor' => $usuario->getNombreCompleto(), 'contenido' => $contenido,)), 'text/html');
    ...
    public function ListarUsuarios($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0) {
        ...
        $lista = $this->getDoctrine()->getRepository('IcanBundle:Usuario')->ListarUsuarios($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0);
        ...
        foreach ($lista as $value) {
            ...
            $arreglo_resultado[$cont] = array("id" => $usuario_id, 'email' => $value->getEmail(), 'nombre' => $value->getNombre(), 'apellidos' => $value->getApellidos(), 'habilitado' => ($value->getHabilitado()) ? 1 : 0, 'perfil' => $value->getRol()->getNombre(), "acciones" => $acciones);
    ...
    public function TotalUsuarios($sSearch) {
        $total = $this->getDoctrine()->getRepository('IcanBundle:Usuario')->TotalUsuarios($sSearch);
