...
class MarcaController extends BaseController
{
    ...
    public function EliminarImagen($imagen) {
        ...
        $entity = $this->getDoctrine()->getRepository('IcanBundle:Marca')->findOneBy(array('imagen' => $imagen));
        if ($entity != null) {
            $entity->setImagen("");
        }
    ...
    public function EliminarMarca($marca_id) {
        ...
        if ($entity != null) {
            ...
            //Productos
            $productos = $this->getDoctrine()->getRepository('IcanBundle:Producto')->ListarProductosDeMarca($marca_id);
    ...
    public function ActualizarMarca($marca_id, $nombre, $titulo, $descripcion, $tags, $estado, $imagen) {
        ...
        if ($entity != null) {
            //Verificar nombre
            $marca = $this->getDoctrine()->getRepository('IcanBundle:Marca')->findOneBy(array('nombre' => $nombre));
            if ($marca != null) {
            ...
            $i = 1;
            $paux = $this->getDoctrine()->getRepository('IcanBundle:Marca')->BuscarPorUrl($url);
    ...
    public function ListarMarcas($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0) {
        ...
        $lista = $this->getDoctrine()->getRepository('IcanBundle:Marca')->ListarMarcas($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0);
        ...
        foreach ($lista as $value) {
            ...
            $arreglo_resultado[$cont] = array("id" => $marca_id, "nombre" => $value->getNombre(), "descripcion" => $value->getDescripcion(), "estado" => ($value->getEstado()) ? 1 : 0, "imagen" => $imagen, "acciones" => $acciones);
    ...
    public function TotalMarcas($sSearch) {
        $total = $this->getDoctrine()->getRepository('IcanBundle:Marca')->TotalMarcas($sSearch);
